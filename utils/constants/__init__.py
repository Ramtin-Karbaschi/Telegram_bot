...
• برای مشاهده وضعیت اشتراک خود و همچنین تکمیل یا اصلاح سایر اطلاعات پروفایل (مانند سال تولد، تحصیلات و...)، گزینه «👤 پروفایل کاربری» را انتخاب نمایید.
...
پس از تکمیل ثبت نام اولیه، می‌توانید در هر زمان از طریق منو «👤 پروفایل کاربری» و سپس گزینه «اصلاح و تکمیل اطلاعات»، پروفایل خود را کامل کنید.
