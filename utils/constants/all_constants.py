...
برای شروع، می‌توانید از طریق گزینه «📝 ثبت نام» اطلاعات خود را وارد کرده و سپس با انتخاب «🛒 خدمات VIP» اشتراک مورد نظر خود را تهیه نمایید.
...
🔹 <b>شروع کار با ربات:</b>
   ...
   • اگر قبلاً ثبت نام کرده‌اید، می‌توانید با گزینه «🛒 خدمات VIP» اشتراک خود را تهیه یا تمدید کنید.
   • اگر قبلاً اشتراک خریده اید، می توانید با انتخاب گزینه «👤 پروفایل کاربری» وضعیت اشتراک خود را بررسی کنید.
   • برای خدمت‌رسانی بهتر، لطفاً از قسمت «اصلاح و تکمیل اطلاعات»، اطلاعات خود را تکمیل کنید.
...
1️⃣ در این کانال، داده‌های فاندامنتال (بنیادی) و تحلیل‌های کوتاه‌مدت و میان‌مدت بازارهای بورس و کریپتو منتشر می‌شود. با عضویت در کانال به تحلیل‌های گذشته نیز دسترسی خواهید داشت؛ بنابراین اشتراک صرفاً محدود به داده‌های بعد از تاریخ عضویت نیست. بنابراین مبلغ پرداختی اشتراک قابل بازگشت نمی‌باشد.

2️⃣ محتوای کانال شامل تحلیل، مدیریت پورتفولیو و آموزش جهت ارتقای سطح معامله‌گری شماست.
...
7️⃣ آکادمی دارایی توصیه‌ای به معاملات فیوچرز یا معاملات با ریسک بسیار بالا که ممکن است منجر به از دست رفتن سرمایه شود ندارد؛ لطفاً نگهبان سرمایه خود باشید.
"""
...
⚠️ پس از واریز:
1️⃣ عبارت «Tx Hash» تراکنش خود را کپی کنید.
2️⃣ بر روی دکمه «🔗 ارسال Tx Hash» کلیک کنید.
3️⃣ عبارت «Tx Hash» تراکنش خود را الصاق کرده و ارسال کنید."""
